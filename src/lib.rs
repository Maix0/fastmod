...
pub fn get_file_set(matches: &clap::ArgMatches) -> Option<FileSet> {
...
impl Fastmod {
    pub fn new(accept_all: bool, hidden: bool, print_changed_files: bool) -> Fastmod {
        Fastmod {
